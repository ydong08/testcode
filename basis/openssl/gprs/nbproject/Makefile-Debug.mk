...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V3/Debug/gprs.exe

dist/V3/Debug/gprs.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V3/Debug
	arm-brcm-linux-gnueabi-g++ -o dist/V3/Debug/gprs ${OBJECTFILES} ${LDLIBSOPTIONS} -L . "-L${SDKV3LIB}" "-L${SDKV3LIBN}"
